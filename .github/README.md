...
[`@aws-sdk/client-codeguru-security`](https://www.npmjs.com/package/@aws-sdk/client-codeguru-security/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeguru-security@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MBHDR4PJk3T30expwAlBtUXPF8ynCAXT3R4yDFlemLDBxRnyyngczL+G40lMPWP2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codeguru-security": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeguru-security@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeguru-security@3.521.0/index.min.mjs": "sha384-MBHDR4PJk3T30expwAlBtUXPF8ynCAXT3R4yDFlemLDBxRnyyngczL+G40lMPWP2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codeguru-security/blob/refs/tags/3.521.0/LICENSE
```
